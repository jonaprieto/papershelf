...
/// PDFHammer/AI.swift itself has no test target, so this is the only place the "usage
...
//
// ASSUMED SHAPE, because Sources/PDFHammerCore/Library.swift does not exist in this
